...
{elseif $action eq 16} {* Browse memberships for a contact *}
    ...
    <div id="memberships">
        ...
        <table id="active_membership" class="display">
            ...
            <tr id="crm-membership_{$activeMember.id}" class="{cycle values="odd-row,even-row"} {$activeMember.class} crm-membership">
                ...
                <td><a href="{crmURL p='civicrm/membershiphistory' q="cid=`$contactId`&mid=`$activeMember.id`"}" class="action-item crm-hover-button" title="View Membership">View</a></td>
                <td>
    ...
    <th></th>
        ...
        {if $inActiveMember.owner_membership_id}<br />({ts}by relationship{/ts}){/if}
                ...
                <td><a href="{crmURL p='civicrm/membershiphistory' q="cid=`$contactId`&mid=`$inActiveMember.id`"}" class="action-item crm-hover-button" title="View Membership">View
